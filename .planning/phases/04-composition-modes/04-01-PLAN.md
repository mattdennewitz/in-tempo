...
must_haves:
  truths:
    ...
    - "Performers maintain appropriate clustering regardless of pattern count"
  artifacts:
...
5. In `Ensemble.performerStates` getter:
   ...
   - `currentRep = s.totalRepetitions - s.repetitionsRemaining + 1` (1-based: 1 means playing first rep, matching UI format "1/4")
